...
public class AlertCriteriaRepositoryAdapter implements AlertCriteriaRepositoryPort {
    ...
    private AlertCriteria toDomain(AlertCriteriaEntity entity) {
        return AlertCriteria.builder()
                ...
                .humidityThreshold(entity.getHumidityThreshold())
                .humidityDirection(entity.getHumidityDirection())
                .dewPointThreshold(entity.getDewPointThreshold())
                .dewPointDirection(entity.getDewPointDirection())
                .windGustThreshold(entity.getWindGustThreshold())
                .skyCoverThreshold(entity.getSkyCoverThreshold())
                .skyCoverDirection(entity.getSkyCoverDirection())
                .riverGaugeId(entity.getRiverGaugeId())
                .riverStageThreshold(entity.getRiverStageThreshold())
                .riverStageDirection(entity.getRiverStageDirection())
                .riverFloodCategoryThreshold(entity.getRiverFloodCategoryThreshold())
